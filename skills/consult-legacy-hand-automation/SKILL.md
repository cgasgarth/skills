---
name: consult-legacy-hand-automation
description: Reference-only archive of the manual ChatGPT consultation workflow. Use only when explicitly asked to inspect or run the legacy hand-automated process instead of the canonical scripted Consult skill.
---

# Consult Legacy Hand Automation
